...
namespace BAIGUZINLANGUAGE
{
    ...
    public partial class Client
    {
        ...
        public string Bday => Birthday.ToShortDateString();
        public string ShortReg => RegistrationDate.ToShortDateString();
        ...
        public int VisitCount
        {
            get
            {
                return Convert.ToInt32(BaiguzinLanguageEntities.GetContext().ClientService.Where(x => x.ClientID == this.ID).Count());
            }
        }
